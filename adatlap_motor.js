...
// finomításnál — az adatlap_teszt.html-hez nem kell hozzányúlni.
  ...
  document.getElementById('feszitesiTervBeolvasBtn').addEventListener('click', () => {
    ...
    hibaEl.textContent = '';
    const szoveg = document.getElementById('feszitesiTervBemenet').value;
    try {
